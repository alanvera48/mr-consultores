...
const content = {
  es: {
    ...
    intro:
      "En MR Consultores utilizamos cookies y tecnologías similares para garantizar el correcto funcionamiento del sitio, recordar tus preferencias y entender cómo se utiliza la web. A continuación te explicamos qué son, cuáles usamos y cómo podés gestionarlas.",
  ...
  en: {
    ...
    intro:
      "At MR Consultores we use cookies and similar technologies to ensure the site works properly, remember your preferences and understand how the website is used. Below we explain what they are, which ones we use and how you can manage them.",
  ...
  return (
    <section className="section cookie-policy">
      <div className="wrap">
        ...
        <p>
          {c.s4p}
          <a href="mailto:mriverorrhh@hotmail.com" className="cookie-policy__mail">
            mriverorrhh@hotmail.com
          </a>
          .
        </p>
      </div>
