        ...
        <div className="footer-grid">
          <div>
            ...
            <div className="socials">
              <a
                className="cs-link"
                href="mailto:mriverorrhh@hotmail.com"
                aria-label="Correo"
                data-cursor=""
              >
          ...
          <div>
            ...
            <ul>
              {units.map((u) => (
                <li key={u.slug}>
                  <a href={`/unidades/${u.slug}`}>{t.unitNames[u.key].name}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul>
              <li><a href="mailto:mriverorrhh@hotmail.com">mriverorrhh@hotmail.com</a></li>
              <li><a href="tel:+543516546850">+54 351 654 6850</a></li>
